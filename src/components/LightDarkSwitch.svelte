...
<div class="relative z-50 shrink-0" role="menu" tabindex="-1" on:mouseleave={hidePanel}>
	<button
		aria-label="Light/Dark Mode"
		role="menuitem"
		class="relative btn-plain scale-animation rounded-lg h-11 w-11 !flex items-center justify-center active:scale-90 shrink-0"
		id="scheme-switch"
